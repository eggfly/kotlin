...
internal abstract class FirBaseTowerResolveTask(
    ...
    protected fun ReceiverValue.toDispatchReceiverMemberTowerLevel(
        extensionReceiver: ReceiverValue? = null,
        contextReceiverGroup: ContextReceiverGroup? = null,
        skipSynthetics: Boolean = false,
    ) = DispatchReceiverMemberTowerLevel(
        components, this,
        givenExtensionReceiverOptions = createExtensionReceiverOptions(contextReceiverGroup, extensionReceiver),
        skipSynthetics = skipSynthetics,
    )

    protected fun ContextReceiverGroup.toDispatchReceiverMemberTowerLevel(
        extensionReceiver: ReceiverValue? = null,
...
internal open class FirTowerResolveTask(
    ...
    suspend fun runResolverForExpressionReceiver(
        ...
        processLevel(
            explicitReceiverValue.toDispatchReceiverMemberTowerLevel(), info, parentGroup.Member, ExplicitReceiverKind.DISPATCH_RECEIVER
        )
        ...
        enumerateTowerLevels(
            ...
            onImplicitReceiver = { implicitReceiverValue, group ->
                // Member extensions
                processLevel(
                    implicitReceiverValue.toDispatchReceiverMemberTowerLevel(extensionReceiver = explicitReceiverValue),
                    info, group.Member, ExplicitReceiverKind.EXTENSION_RECEIVER
                )
            },
            onContextReceiverGroup = { contextReceiverGroup, towerGroup ->
                processLevel(
                    contextReceiverGroup.toDispatchReceiverMemberTowerLevel(extensionReceiver = explicitReceiverValue),
    ...
    suspend fun runResolverForSuperReceiver(
        ...
        processLevel(
            receiverValue.toDispatchReceiverMemberTowerLevel(),
    ...
    private suspend fun processCandidatesWithGivenImplicitReceiverAsValue(
        ...
        processLevel(
            receiver.toDispatchReceiverMemberTowerLevel(skipSynthetics = skipSynthetics), info, parentGroup.Member,
            onEmptyLevel = {
        ...
        enumerateTowerLevels(
            ...
            onImplicitReceiver = l@{ implicitReceiverValue, group ->
                ...
                processLevel(
                    implicitReceiverValue.toDispatchReceiverMemberTowerLevel(extensionReceiver = receiver),
                    info, group
                )
            },
            onContextReceiverGroup = { contextReceiverGroup, towerGroup ->
                processLevel(
                    contextReceiverGroup.toDispatchReceiverMemberTowerLevel(extensionReceiver = receiver),
                    info, towerGroup
                )
            },
        )
    ...
    private suspend fun processCandidatesWithGivenContextReceiverGroup(
        ...
        processLevel(
            contextReceiverGroup.toDispatchReceiverMemberTowerLevel(), info, parentGroup.Member,
        )
        ...
        enumerateTowerLevels(
            ...
            onImplicitReceiver = { implicitReceiverValue, towerGroup ->
                processLevel(
                    implicitReceiverValue.toDispatchReceiverMemberTowerLevel(contextReceiverGroup = contextReceiverGroup),
                    info, towerGroup
                )
            },
            onContextReceiverGroup = { otherContextReceiverGroup, towerGroup ->
                processLevel(
                    contextReceiverGroup.toDispatchReceiverMemberTowerLevel(otherContextReceiverGroup = otherContextReceiverGroup),
                    info, towerGroup,
                )
            }
        )
