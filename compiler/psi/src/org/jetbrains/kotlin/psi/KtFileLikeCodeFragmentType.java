...
public class KtFileLikeCodeFragmentType extends ICodeFragmentElementType {
    private static final String NAME = "kotlin.BLOCK_CODE_FRAGMENT";

    public KtFileLikeCodeFragmentType() {
    ...
    protected ASTNode doParseContents(@NotNull ASTNode chameleon, @NotNull PsiElement psi) {
        ...
        return KotlinParser.parseFileLikeCodeFragment(builder).getFirstChildNode();
    }
}
