...
KChar advanceIfInSurrogatePair(It& iterator) { return iterator.ptr() == nullptr ? *iterator++ : 0; }

template <typename It>
KChar retractIfInSurrogatePair(It& iterator) { return iterator.ptr() == nullptr ? *iterator-- : 0; }
